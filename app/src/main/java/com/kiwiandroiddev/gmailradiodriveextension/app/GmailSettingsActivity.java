...
public class GmailSettingsActivity extends BaseSettingsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setIcon(R.drawable.ic_gmail);
    }
    ...
    protected void setupSimplePreferencesScreen() {
        ...
        bindPreferenceSummaryToValue(findPreference(GmailAnnouncement.PREF_LABEL));
    }

    private void addAccountsPreference() {
        final String[] accounts = GmailAnnouncement.getAllAccountNames(this);
        ...
        accountsPreference.setKey(GmailAnnouncement.PREF_ACCOUNTS);
